...
rm -f "$HOME/.jsfmtrc"
ln -s "$SCRIPTPATH/.jsfmtrc" "$HOME/.jsfmtrc"
echo "Symlinked .jsfmtrc to $HOME/.jsfmtrc"
rm -f "$HOME/.jshintrc"
ln -s "$SCRIPTPATH/.jshintrc" "$HOME/.jshintrc"
echo "Symlinked .jshintrc to $HOME/.jshintrc"
rm -f "$HOME/.xbindkeysrc"
ln -s "$SCRIPTPATH/.xbindkeysrc" "$HOME/.xbindkeysrc"
echo "Symlinked .xbindkeysrc to $HOME/.xbindkeysrc"
rm -f "$HOME/.bashrc"
ln -s "$SCRIPTPATH/.bashrc" "$HOME/.bashrc"
echo "Symlinked .bashrc to $HOME/.bashrc"
rm -f "$HOME/.bash_profile"
ln -s "$SCRIPTPATH/.bash_profile" "$HOME/.bash_profile"
echo "Symlinked .bash_profile to $HOME/.bash_profile"
rm -f "$HOME/.wxMaxima"
ln -s "$SCRIPTPATH/.wxMaxima" "$HOME/.wxMaxima"
echo "Symlinked .wxMaxima to $HOME/.wxMaxima"
