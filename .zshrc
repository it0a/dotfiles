...
alias rxs2='echo "Pulling Blackcomb..." && cd ~/develop/streamlinx/blackcomb && git up && echo "Pulling SmartsToo..." && cd ~/develop/streamlinx/smartstoo && git up'
alias txs2='echo "Pushing Blackcomb..." && cd ~/develop/streamlinx/blackcomb && git push origin dev && echo "Pushing SmartsToo..." && cd ~/develop/streamlinx/smartstoo && git push origin dev'
